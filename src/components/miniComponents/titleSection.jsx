const TitleSection = ({name}) => {
    return (
        <div className="self-start absolute -left-3 top-10 flex items-center gap-4">
            <div className="h-8 w-8 lg:h-10 lg:w-10 flex justify-center items-center bg-slate-700 rounded-full text-white">
            ...
            <h3 className="text-slate-700 text-xl lg:text-2xl font-bold border-b-2 border-slate-700">{name}</h3>
        </div>
    )
}
